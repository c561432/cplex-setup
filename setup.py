...
VERSION_ERROR = 'CPLEX 12.9.0.0 is not compatible with this version of Python.'
...
def is_supported_version():
    ...
    return (major == 2 and minor == 7) or (major == 3 and minor in (6, 7))
...
def get_data():
    ...
    if is_windows():
        ...
        ext = '.so'
        extra = []
    data = ['py%d%d_cplex1290%s' % (major, minor, ext)]
    data.extend(extra)
    return data
